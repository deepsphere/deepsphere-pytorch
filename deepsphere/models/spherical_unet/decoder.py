...
class SphericalChebBNPoolCheb(nn.Module):
    ...
    def __init__(self, in_channels, middle_channels, out_channels, lap, pooling, kernel_size=3):
        """Initialization.
...
class Decoder(nn.Module):
    ...
    def __init__(self, unpooling, laps):
        """Initialization.
        ...
        self.dec_l1 = SphericalChebBNPoolConcat(512, 512, laps[1], self.unpooling)
